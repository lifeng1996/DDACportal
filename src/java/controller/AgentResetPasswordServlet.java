 ...
 * @author tan
 */
public class AgentResetPasswordServlet extends HttpServlet {
 ...
 String driver ="com.microsoft.sqlserver.jdbc.SQLServerDriver";
        try {
           ...
           String sql;
           sql = "UPDATE Agent SET PASS = \'0000\' WHERE UID = "+id;
           stmt.executeUpdate(sql);
           stmt.close();
           out.println("<script type=\"text/javascript\">");
   out.println("alert('Account password is reset Successfully');");
