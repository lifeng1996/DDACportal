<%-- 
    Document   : homepage
    Created on : Mar 20, 2018, 6:00:38 PM
    Author     : tan
--%>
...
<html>
   <head>
  <title>Maersk Line-Admin-Welcome</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
            <a class="navbar-brand" href="adminloginpage.jsp"><img style="opacity: 0.8" alt="MaerskLine" src="logo.png" width="150" height="65"></a>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="admin.jpg" alt="Admin" width="900" height="500">
      ...
      <div class="item">
        <img src="global.jpg" alt="Agent" width="900" height="500">
        <div class="carousel-caption" >
          <h1>Going to Agent Portal?</h1>
          <br>
          <div><button id="toagentpage" type="submit" class="btn btn-block">Navigate to Agent Login Page! 
              </button></div>
           <script>
    document.getElementById("toagentpage").onclick = function () {
...
<div id="contact" class="container">
  ...
  <div class="row">
    <div class="col-md-4">
      <p>Drop a note.</p>
      <p><span class="glyphicon glyphicon-map-marker"></span>Kuala Lumpur, KLCC</p>
      <p><span class="glyphicon glyphicon-phone"></span>Phone: +60 163164254</p>
      <p><span class="glyphicon glyphicon-envelope"></span>Email: maerskline@maersk.com</p>
    </div>
    <div class="col-md-8">
