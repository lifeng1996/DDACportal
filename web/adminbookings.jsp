...
<html>
       ...
       <ul class="nav navbar-nav navbar-right">
        ...
        <div id="band" class="container-fluid text-center">  
            ...
            <div class="row content">
                ...
                <div id="contentbox" class="col-sm-10  text-justify">
                    <div class="searchbox">
 ...
 String driver ="com.microsoft.sqlserver.jdbc.SQLServerDriver";
        try {
           ...
           String sql;
           sql = "SELECT b.BID,c.NAME,c.ICNUMBER ,s.SOURCE ,s.DESTINATION,s.SHIPDATE,b.STATUS from Booking b,Schedule s, Customer c, Items i WHERE b.CUSTOMER_ID = c.CID and b.SCHEDULE_ID=s.SID and b.ITEM_ID=i.IID ORDER BY BID DESC";
         ...
         <td class="text-center">
            <div>
                <div class="col-sm-6 ">
                                        ...
                                        <form id="deletation" action="BookingOperationServlet" method="POST">
                <div class="col-sm-6 ">
                                        <input type="hidden" name="adid" id="adid" value="<%=rs.getString("BID")%>">
                                        <input type="hidden" name="operation" id="operation" value="Approve">
                                        <a ><button class="btn btn-default btn-sm">Approve</button></a>
                ...
                <div class="col-sm-6 ">
                                        ...
                                        <a ><button class="btn btn-default btn-sm">Decline</button></a>
