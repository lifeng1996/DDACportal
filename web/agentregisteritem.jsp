...
<html>
  ...
  <div class="container-fluid">
    ...
    <div class="form-group">
      <label for="username">Item Name: </label><p id="announce"></p>
      <input type="username" class="form-control" id="regisemail" name="regisemail" placeholder="Enter Item Name" required>
      </div>
               <div class="form-group">
      <label for="quantity">Quantity:</label>
      <input type="username" class="form-control" id="quantity" name="quantity" pattern="[0-9]{,4}" title="Please Enter Proper Quatity" placeholder="Enter Item Quantity" required>
    </div>
              <div class="form-group">
      <label for="weight">Total Weight:</label>
      <input type="username" class="form-control" id="weight" name="weight" pattern="[0-9]{,4}" title="Please Enter Proper Weight" placeholder="Enter total weight of items" required>
    </div>
              <div class="form-group">
      <label for="state">Item Category:</label>
      <div class="dropdown">
                                        <select id="category" name="category">
                                            <option value="Raw Materials">Raw Materials</option>
                                            <option value="End Products">End Products</option>
