...
<html>
  ...
  <div class="container-fluid">
    ...
    <div class="form-group">
      ...
      <input type="username" class="form-control" id="ic" name="ic" placeholder="Enter Customer IC" required>
    </div>
              <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="username" class="form-control" id="contact" name="contact" placeholder="Enter Contact Number" pattern="[0-9]{9,}" title="Please Insert Proper Number" required>
    </div>
    <div class="form-group">
      <label for="add">Address:</label><span id='message'></span>
      <input type="username" class="form-control" id="address" name="address" placeholder="Enter Address" required>
    </div>
              <br>
